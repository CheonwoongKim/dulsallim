...
- **할부**는 고정비에 끝을 붙인 것입니다. 몇 개월인지 적으면 그만큼만 기록되고,
  목록에서 몇 회째인지와 언제 끝나는지를 봅니다. 시작월은 직접 고릅니다 —
  카드 첫 청구가 다음 달이면 그 달부터 잡아야 합니다
...
| 21 | `supabase/migrations/20260922000000_installment_months.sql` | 할부 — 고정비에 "몇 번 하고 그만둘지" 를 붙인다 |
