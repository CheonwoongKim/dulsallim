...
export const elements = {
  ...
  wishMenuGoal: document.querySelector("#wish-menu-goal"),
  wishMenuGoalLabel: document.querySelector("#wish-menu-goal-label"),
  wishMenuGoalHint: document.querySelector("#wish-menu-goal-hint"),
